      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <?php if($level == 1){ ?>
            <!-- <div class="col-md-6"> -->
           <!--  <a class="btn btn-md btn-success" href="<?php echo base_url('tambahdata/adddata');?>">Tambah Data Masuk</a> -->
            <!--  </div> -->
            <?php } ?>

            <center><h3>Obat Kadaluarsa</h3></center>
          ...
          <div class="panel-body">
            ...
            <table data-toggle="table"  data-show-refresh="false" data-show-toggle="false" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="tgl_kadaluarsa" data-sort-order="asc">
              ...
              <thead>
                <tr>
                 <!--  <th data-field="id_jenis_obat"  > Katagori Obat  </th> -->
                  ...
                  <th data-field="kadaluarsa" > Masa Kadaluarsa  </th>
             ...
             <!--      <th data-field="tgl_masuk" > Tanggal Masuk  </th> -->
              ...
              <!--     <th data-field="username"  >Nama Pegawai  </th> -->
                  <th data-field="aksi" ><center> Aksi  </center></th>
                </tr>
              </thead>
              <tbody>
               ...
               <!--      <td style="font-size: 12px;"><?php echo $row->tgl_sales; ?></td> -->
                 ...
                 <!--    <td style="font-size: 12px;width:180px"><?php echo $row->nama; ?></td> -->
                    ...
                    <td style="width:120px">
                      ...
                      <!--   <?php  
                        echo anchor('tambahdata/editdata/'.$row->id_obat, '<span class="glyphicon glyphicon-pencil"></span>', array('class' =>'btn btn-success btn-sm','title'=>'Edit data ')); 
                        ?> -->
<!-- 
              ...
              <!--   <a class="btn btn-danger btn-xs" href="<?php echo base_url('tambahdata/hapusdata/'.$row->id_obat);?>"
                ...
                -->
                <?php echo anchor('tambahdata/hapusdata/'.$row->id_obat, '<span class="glyphicon glyphicon-trash"> HAPUS</span>', array('id'=>'hapus','class' =>'btn btn-danger btn-sm','title'=>'Hapus data '));
                ?>
